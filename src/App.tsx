      ...
      <header className="bg-gradient-to-br from-indigo-500 to-purple-600 text-white py-16 px-8 text-center flex-1 flex items-center justify-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <button className="bg-red-500 hover:bg-red-600 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-lg shadow-red-500/40">
              Play Now
            </button>
